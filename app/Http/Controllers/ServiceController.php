...
class ServiceController extends Controller
{
    ...
    public function addService(Request $request){
        ...
        return view('admin.product.add_service')->with(compact('category_dropdown'));
    }
    public function viewservices(){
        ...
        return view('admin.product.view_service')->with(compact('service'));
    }
    public function editservice(Request $request,$id){
        ...
        return view('admin.product.edit_service')->with(compact('service','category_dropdown'));
    }
